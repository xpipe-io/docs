...
<Callout type="info">If you are looking for deploying XPipe in your organization and want to use managed installs, check out the managed installation guide instead.</Callout>
