...
This will make the connection creation much easier. You can also create identities through the same API and with the same encrypted values for the password and SSH key; however, it is easier to use in the GUI.
