...
To control for which addresses the proxy should not be used, you can add a list of addresses in the settings menu:

![](/images/no-proxy.png)

This is equivalent to the `NO_PROXY` environment variable.
