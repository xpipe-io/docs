...
Creating a PowerShell remote session connection is pretty simple, assuming that the remote system is configured to allow these kinds of connections. Then you just have to enter the hostname (called computer name here) along with the login information, and you should be good to go:
