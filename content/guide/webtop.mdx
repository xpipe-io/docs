...
<Callout type="info">The deployment wizard is the recommended way to create the Webtop container. It supports all possible configuration options, performs various sanity checks, and minimizes the possibilities of errors. You can still deploy the created wizard template manually if you want.</Callout>
