...
With XPipe's scripting functionality, you can enhance and customize your workflow. Scripts can be applied at many locations in XPipe, each one having unique properties. In summary, you can run scripts at:
...
As you can use a script in multiple different scenarios, you should first choose for which execution type you want to create the script for. These different types are explained on this page next.
