...
If you prefer videos, check out the Scripting Guide video, which covers the same aspects as this page:

<div class="video-wrapper">
    <iframe src="https://www.youtube.com/embed/0o7oy8k-qlA?si=eVpnmMug4J6NwG-N" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encryted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>.
</div>
