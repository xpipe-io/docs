...
Furthermore, GPG signing will slow down operations somewhat as this process is not very fast when doing a lot of commits. If you don't like this slowdown, you can consider turning off GPG signing for the XPipe vault repository with `git config commit.gpgSign false` in the repository directory.
