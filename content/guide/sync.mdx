...
However, if you don't need this, and use the git sync primarily as a backup functionality, you can disable this in the settings menu:

![](/images/sync-instantly.png)

This will reduce the amount of pushed commits by squashing them. It will also reduce the amount of times changes are pushed to the remote.
