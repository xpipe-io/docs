...
You can deploy the [XPipe Webtop container](/guide/webtop#usage-as-an-api-server) as an API server to have a central server that is linked to your vault and can handle connection updates via the API.
