...
If you want to [sync](/guide/sync) your Hetzner Cloud connections across multiple devices or share them with other team members, you can sync the config file by pressing the sync button:
