...
As described later on for some terminals, having a custom prompt might interfere with other prompt-based terminal integrations, e.g. for the Warp terminal.
