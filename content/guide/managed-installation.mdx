...
```powershell
Start-Process -FilePath "msiexec.exe" -ArgumentList "/i `"https://github.com/xpipe-io/xpipe/releases/latest/download/xpipe-installer-windows-x86_64.msi`" /qn" -Wait -PassThru
```
...
```powershell
Start-Process -Verb runAs -FilePath "msiexec.exe" -ArgumentList "/i `"https://github.com/xpipe-io/xpipe/releases/latest/download/xpipe-installer-windows-x86_64.msi`" /qn ALLUSERS=1" -Wait -PassThru
```
