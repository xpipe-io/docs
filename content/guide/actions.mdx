...
In a production environment, you might want to double-check any action you perform to avoid any accidents. XPipe gives you the option to configure a [category](/guide/hub#configuration) to require an explicit confirmation for any action that modifies some data:
