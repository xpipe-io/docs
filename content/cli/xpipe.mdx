...
Command-line interface to interact with the XPipe daemon. Note that the daemon executable xpiped does not accept any command-line arguments and that you should use the xpipe CLI executable.
...
[**daemon**](/cli/xpipe-daemon):
Commands for controlling the XPipe daemon

[**version**](/cli/xpipe-version):
